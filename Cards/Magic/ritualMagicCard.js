...
function storeRitualMagicCards() {
  //create ritual magic card sub-class from CardEffectCreator
  class RitualMagicCard extends CardEffectCreator {
  ...
  return function (ritualMagicCardName, requirements, effects) {
    ...
    if (ritualMagicCardsCache[ritualMagicCardName]) {
      return Object.assign(Object.create(ritualMagicCardsCache[ritualMagicCardName]), ritualMagicCardsCache[ritualMagicCardName]);
    }
